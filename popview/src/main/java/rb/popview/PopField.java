...
public class PopField extends View {
    ...
    /**
     * Hiding a view by popping animation
     */
    ...
    /**
     * Hide a view by popping animation, then assemble its particle to show a new view
     */
    ...
    /**
     * Dissemble a view, replace with a new view
     */
    public void popView(final View view, View addView, boolean isAnimated) {
        ...
        if (isAnimated) {
            // Show the new view with reverse popping animation
            ...
            // Just show a new view after animation
            popView(PopUtils.createBitmapFromView(view), r, startDelay, PopAnimator.DEFAULT_DURATION);
            ...
            parentViewGroup.removeView(view);
            parentViewGroup.addView(addView, index);
            ViewGroup.LayoutParams lp = addView.getLayoutParams();
            Log.d("PopField", "");
        }
    }
